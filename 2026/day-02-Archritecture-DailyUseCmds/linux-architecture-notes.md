...
**init/systemd** - It is first process start by the OS with PID = 1 during the boot sequence. it control crucial process starting/ stopping process using **systemctl** command
